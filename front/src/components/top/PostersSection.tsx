    ...
    return (
        <section
            ...
            <div
                ...
                <FadeInWhenVisible>
                    <h2 className={dotGothic16Font.className + " block mt-auto text-[5vh]"}>屋台・自主企画</h2>
                </FadeInWhenVisible>
                ...
                <FadeInWhenVisible>
                    <div
                        className={dotGothic16Font.className + "block  mt-auto text-[2vh]"}>ポスターをタップで詳細を表示
                    </div>
                </FadeInWhenVisible>
            </div>
            ...
            <div
                ...
                <div className="w-full h-1/3 flex flex-col items-center justify-start">
                    <FadeInWhenVisible className={"text-center mb-1"}>
                        <h2 className={dotGothic16Font.className + " block text-[5vh]"}>屋台・自主企画</h2>
                    </FadeInWhenVisible>
                    <FadeInWhenVisible className={"text-center mb-1"}>
                        <div className={dotGothic16Font.className + " block text-[3vh]"}>09:00 ~ 17:00</div>
                    </FadeInWhenVisible>
                    <FadeInWhenVisible className={"text-center mb-8"}>
                        <div
                            className={dotGothic16Font.className + " block text-[2vh]"}>← ポスターをスクロールで表示切り替え
                        </div>
                    </FadeInWhenVisible>
                ...
                <div className="hidden lg:flex flex-col h-2/3 justify-start items-center pt-8 px-4">
                    {selectedPoster && (
                        <FadeInWhenVisible>
                            <h2 className={dotGothic16Font.className + " block font-bold text-center mb-8 text-[4vh]"}>{selectedPoster.title}</h2>
                            {
                                selectedPoster.desc &&
                                <p className={dotGothic16Font.className + " whitespace-pre-wrap text-center text-[2vh] mt-4"}>"{selectedPoster.desc}"</p>
                            }
                        </FadeInWhenVisible>
                    )}
                    <button className={"ml-auto mt-auto mb-4 text-right"}>マップで見る &lg;</button>
                </div>
            </div>
        </section>
    )
