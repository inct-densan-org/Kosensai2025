...
export default function Navigation() {
    return (
        <nav
            className={"sticky bg-blur-sm h-12 w-auto mx-4 mt-4  top-4 backdrop-blur-sm border-gray-800 border-[1px] rounded-xl flex items-center px-4 gap-2 justify-around"}>
            <a className={dotGothic16Font.className + " text-md tracking-wide text-foreground"}
