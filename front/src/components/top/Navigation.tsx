...
export default function Navigation() {
    return (
        <nav
            className={"sticky h-12 w-[calc(100%-32px)] mx-4 top-4 z-[100] backdrop-blur-lg mt-4 border-white border-[1px] rounded-xl flex items-center px-4 gap-2 justify-around "}>
