...
export default function EventsLayout({ children }: { children: React.ReactNode }) {
    return (
        ...
        <main className={" relative w-screen min-h-dvh h-auto flex-col pt-16 overflow-x-hidden overflow-y-auto items-center justify-between bg-[#000000] bg-no-repeat bg-(image:--dark-mesh-gradient) blur-in-3xl hidden-scrollbar bg-fixed"}>
                <Navigation/>
                {children}
        </main>
    );
